    ...
    return (
        <div className="mainWrapper" style={{ direction: language != "fa" ? "ltr" : "rtl" }}>
            ...
            <div className="main">
                ...
                <p className="description">{t("glo3d_pricing_p1")}</p>
                <div className="description-features">
                    {t("glo3d_pricing_features_before")}
                    {t("glo3d_pricing_features_list")?.map((i) => (
                        <ul>
                            <li> {i }</li>
                        </ul>
                    ))}
                </div>
                <p className="description">{t("glo3d_pricing_features_after")}</p>
                <p className="description">{t("glo3d_pricing_p3")}</p>
                <br />
                <hr />
            </div>
        </div>
